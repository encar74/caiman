<template>
    <component
        ...
        :class="[
            ...
            {
                'text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-gray-300 dark:hover:bg-dark-400':
                    !active,
                'text-dark-900 bg-sky-300 shadow-lg hover:bg-sky-400':
                    active,
            },
        ]"
        :href="href"
    ...
    <button
        ...
        :class="[
            'p-2 w-full flex items-center gap-2 rounded-md transition-colors',
            {
                'text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-gray-300 dark:hover:bg-dark-400':
                    !active,
                'text-white bg-sky-500 shadow-lg hover:bg-sky-600':
                    active,
            },
        ]"
    >
